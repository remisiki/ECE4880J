...
from myHoughLines import Handwrite_HoughLines, find_local_maxima
...
img0 = cv2.imread('./stu/img/img01.jpg')
# img0 = cv2.imread('./stu/img/test.jpg')
# img0 = cv2.imread('./stu/img/img02.jpg')
# img0 = cv2.imread('./stu/img/lines.png')
...
cv2.imwrite('edge.png', 255 * np.sqrt(img_edge / img_edge.max()))
cv2.imwrite('thres.png', 255 * img_threshold)
cv2.imwrite('hough.png', 255 * img_houghtrans / img_houghtrans.max())
