...
from sparsecodingtools.dictionaries import Dictionary
from sparsecodingtools.pursuits import Pursuit
...
class KSVD:
    ...
    Args:
        dictionary: Initial dictionary of type sparsecodingtools.dictionaries.Dictionary
        pursuit: Pursuit method to be used (any method from sparsecodingtools.pursuits)
